      ...
      <div className="tp-service-funfact-box">
              ...
              <div className="col-lg-12">
                <div className="tp-service-title-wrapper text-center">
                  <h3 className="tp-section-title">
                    All Professional <i>Solutions</i> & Services
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="tp-service-all-btn text-center fadeUp">
                  <Link className="tp-btn" href="/aboutus">
                    View all Services
                  </Link>
                </div>
              </div>
        ...
        <section className="tp-fun-fact-area pt-80 pb-65 p-relative">
          <div className="container container-1400">
            <div className="tp-fun-fact-shape" style={{ zIndex: "-22" }}>
              <Image
                className="shape-1"
              ...
              <div className="col-lg-6 col-md-12">
                <div className="tp-fun-fact-content">
                  <div className="tp-fun-fact-title-wrapper">
                    <h3 className="tp-section-title">
                      What makes Yourinternetprovider different?
                      <span className="title-left-shape">
                        <LineArrowTwo />
                      </span>
                    </h3>
                    <p>
                      Discover service providers effortlessly. Enter your zip
                      code to access a comprehensive list of internet, TV, and
                      phone providers. Stay updated with our real-time data
                    </p>
                    <ul>
                      <li>
                        <span>
                      ...
                      <li>
                        ...
                        ompare prices, speeds, channels and more
                      </li>
                    </ul>
                    <div className="tp-fun-fact-btn">
                      <Link
                        className="tp-btn"
                        href="mailto:Yourinternetprovider@gmail.com"
                      >
