              ...
              <div className={style.text_center}>
                ...
                <div className={style.icons}>
                  <div className={style.first_icon}>
                    <Img 
                      src={`/assets/img/spectrum/pc.png`} 
                  ...
                  <div className={style.second_icon}>
                    <Img 
                    src={`/assets/img/spectrum/wifi.jfif`} alt="Spectrum Internet service provider" 
                    sizes={{
                      default: [2.5,2],
                      mobile: [9.4,7],
                    }}
                  ...
                  <div className={style.third_icon}>
                    <Img
                     src={`/assets/img/spectrum/mobile.avif`} alt="Spectrum Internet service provider" 
                     sizes={{
                      default: [3.5,2.5],
                      mobile: [5,8.5],
                    }}
            ...
            <div className={style.sec_3div_wrapper}>
              <div className={style.text_center}>
                ...
                <div className={style.icons}>
                  <div className={style.first_icon}>
                    <Img
                     src={`/assets/img/spectrum/pc.png`} alt="Spectrum Internet service provider"
                     sizes={{
                      default: [2,2],
                      mobile: [8.4,7.5],
                    }}
