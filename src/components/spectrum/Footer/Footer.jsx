    ...
    <div className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.image_portion}>
          <img src={`/assets/img/spectrum/logo.jpg`} alt="Internet service provider" />
        </div>
      </div>
      <div className={styles.All_text}>
        <OfferDetail text="Offer Details" para="">
          <p>
            ...
            events. SeeYourinternetprovider for details.
           ...
           Yourinternetprovider for details. UNLIMITED:
            ...
            VisitYourinternetprovider for details.If you're a
           ...
           Yourinternetprovider for details.
          </p>
        </OfferDetail>
        <OfferDetail text="Performance Details" para="">
          <p>
            ...
            Gig capable modems, visitYourinternetprovider
          </p>
        </OfferDetail>
